...
OAuth.GOOGLE_CLIENT_ID = process.env.GOOGLE_CLIENT_ID;
...
OAuth.register = (server) => {
    ...
    handler: function(request, reply){
      ...
      let client_id = request.query.client_id || OAuth.GOOGLE_CLIENT_ID;
    ...
    handler: function(request, reply) {
      ...
      let client_id = OAuth.GOOGLE_CLIENT_ID + ".apps.googleusercontent.com";
